export const LUAT_DAU_THAU_TEXT5 = `### Điều 44. Nội dung hồ sơ mời thầu đối với lựa chọn nhà thầu
...
3. Hệ thống mạng đấu thầu quốc gia hoạt động liên tục, thống nhất, ổn định, có khả năng xác thực người dùng, bảo mật và toàn vẹn dữ liệu.
...
Nhà thầu cung cấp cho chủ đầu tư hoá chất, vật tư xét nghiệm, thiết bị y tế, linh kiện, phụ kiện thay thế và các dịch vụ liên quan để vận hành thiết bị y tế theo số lượng dịch vụ kỹ thuật mà chủ đầu tư yêu cầu trong hồ sơ mời thầu, hồ sơ yêu cầu, không cung cấp nhân công vận hành thiết bị y tế.
